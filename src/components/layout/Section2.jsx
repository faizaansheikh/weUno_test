...
function Section2() {
    return (
        <div className=' w-full h-full flex flex-col items-center md:px-32 lg:px-62'>
            <p className='text-center text-5xl mb-6 mt-12 md:mt-16'>Mall Of: Endless Possibilities</p>
            ...
            <div className=' w-full h-auto px-4 md:px-0 cursor-pointer '>
                <div className='bg-[#2D3813]/90 w-full h-auto py-14 rounded-3xl mt-6 lg:flex  justify-between items-center px-8  hover:bg-[#2D3813]/80 transition-all duration-300'>
                    <div className='flex flex-col gap-6 md:gap-5 '>
                        <p className='text-sm'>25 SR/GUEST</p>
                        <p className='text-3xl'>Get your General Access Ticket</p>
